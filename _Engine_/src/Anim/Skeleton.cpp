...
//std::string Skeleton::GetSkeletonName(Skeleton::Name _name)
//{
//	switch (_name)
//	{
//	case Skeleton::Name::CHICKENBOT_WALK:
//		return std::string("ChickenBot_Walk_");
//		break;
//
//	case Skeleton::Name::CHICKENBOT_RUN:
//		return std::string("ChickenBot_Run_");
//		break;
//
//	case Skeleton::Name::CHICKENBOT_FRONT_HIT:
//		return std::string("ChickenBot_FrontHit_");
//		break;
//
//	case Skeleton::Name::CHICKENBOT_DIE_RIGHT:
//		return std::string("ChickenBot_DieRight_");
//		break;
//
//	case Skeleton::Name::MOUSEY:
//		return std::string("Mousey");
//		break;
//
//	case Skeleton::Name::MOUSEY_WALK:
//		return std::string("MouseyWalk_");
//		break;
//
//	case Skeleton::Name::MOUSEY_RUN:
//		return std::string("MouseyRun_");
//		break;
//
//	case Skeleton::Name::MOUSEY_TPOSE:
//		return std::string("MouseyTPose_");
//		break;
//
//	case Skeleton::Name::MOUSEY_SHUFFLE:
//		return std::string("MouseyShuffle_");
//		break;
//
//	case Skeleton::Name::MOUSEY_GUITAR_PLAYING:
//		return std::string("MouseyGuitarPlay_");
//		break;
//
//	case Skeleton::Name::UNINITIALIZED:
